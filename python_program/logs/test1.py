...
def Ref(stack, fn_name, args):
    LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/functions.pyRef "))
    '''
...
class Join(function.Function):
    ...
    def result(self):
        ...
        def ensure_string(s):
        added: LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/functions.py\Class Join\ ensure_string "))
            if s is None:
                return ''
...
class Replace(function.Function):
    ...
    def result(self):
        ...
        added: LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/functions.py\Class Replace\ replace "))
...
class MemberListToMap(function.Function):
    ...
    def result(self):
        ...
        def item(s):
        added: LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/functions.py\Class MemberListToMap\ item "))
            if not isinstance(s, six.string_types):
