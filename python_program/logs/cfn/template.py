...
class CfnTemplate(template.Template):
    LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate "))
    '''A stack template.'''
    ...
    def __getitem__(self, section):
        LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate/ __getitem__ "))
    ...
    def param_schemata(self, param_defaults=None):
        LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate/ param_schemata "))
    ...
    def parameters(self, stack_identifier, user_params, param_defaults=None):
        LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate/ parameters "))
        return parameters.Parameters(stack_identifier, self,
                                     user_params=user_params,
                                     param_defaults=param_defaults)

    def validate_resource_definitions(self, stack):
        LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate/ validate_resource_definitions "))
    ...
    def resource_definitions(self, stack):
        LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate/ resource_definitions "))
        resources = self.t.get(self.RESOURCES) or {}

        def rsrc_defn_item(name, snippet):
            LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate/ rsrc_defn_item "))
            data = self.parse(stack, snippet)
    ...
    def add_resource(self, definition, name=None):
        LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class CfnTemplate/ add_resource "))
        if name is None:
...
class HeatTemplate(CfnTemplate):
    LOG.info(_LI("soumiyajit::  /home/pankaj/python_program/logs/cfn/template.py/Class HeatTemplate "))
    functions = {
        'Fn::FindInMap': cfn_funcs.FindInMap,
        'Fn::GetAZs': cfn_funcs.GetAZs,
        'Ref': cfn_funcs.Ref,
